...
export function ContactForm({ title, subtitle, image }: ContactFormProps) {
  return (
    <div className="bg-secondary">
      <div className="container-fluid mx-auto px-(--section-padding-x) py-(--section-padding-y)">
        <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-6 md:gap-12">
          ...
          <ContactDetailsSection image={image} />

          {/* Right: Contact Form */}
          <ContactFormSection title={title} subtitle={subtitle} />
        </div>
      </div>
    </div>
  );
...
function ContactDetailsSection({ image }: { image: StrapiImageType }) {
  return (
    <section className="relative h-[400px] md:h-full rounded-2xl shadow-md overflow-hidden">
      {/* Background Image */}
      <StrapiImage
        image={image}
        format="medium"
